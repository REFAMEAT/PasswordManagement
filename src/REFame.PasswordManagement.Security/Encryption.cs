...
namespace REFame.PasswordManagement.Security
{
    ...
    public class Encryption
    {
        ...
        {
            return DecryptString(text, secureKey);
        }

        public static string EncryptString(string text)
        {
            return EncryptString(text, secureKey);
        }

        private const string secureKey = "773E75F0-E29D-4FDF-B7A0-BC3A32E3492F-0D14BE72-6C85-433B-977E-71C2670773A7";
    }
}